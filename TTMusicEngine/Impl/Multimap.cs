...
// NOTE Modified by me - namespace change
namespace TTMusicEngine.Impl
{
    /// <summary>
    /// A data structure that relates multiple values to each key. Keys are sorted too.
    /// </summary>
    ...
    public class Multimap<K, V> : IEnumerable<KeyValuePair<K, List<V>>>
    {
        /*----------------------------------------------------------------------------------------*/
        #region Fields
        private SortedDictionary<K, List<V>> _items = new SortedDictionary<K, List<V>>();
        #endregion
        /*----------------------------------------------------------------------------------------*/
        #region Properties
        /// <summary>
        ...
        public Multimap<K, V> Clone()
        {
            ...
            m._items = new SortedDictionary<K, List<V>>(this._items);
            return m;
        }

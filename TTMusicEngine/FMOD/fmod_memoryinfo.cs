...
namespace FMOD
{
    ...
    */
    ...
    public struct MEMORY_USAGE_DETAILS
    {
        ...
        public uint eventinstance_sound;            /* [out] Event _sound instance objects */
    ...
    */
    public enum EVENT_MEMBITS :uint
    {
        ...
        EVENTINSTANCE_SOUND   = 0x00080000, /* Event _sound instance objects */
